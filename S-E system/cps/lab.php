            ...
            <div class="modal-content">
               ...
               <!--header -->
                 <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" href="lab.php">&times;</button>
...
<div class="jumbotron">
            <div class="container">
                  <h1 class="itro-text">Lights and Bulbs
                  </h1>
            </div> 
</div> 
...
<div class="container">
  <div class="row">
        ...
        <?php
          $query = "SELECT * FROM product where category='Light and Bulbs' ORDER BY product_id ASC";
        ...
        ?>
            <div class="col-md-4">
              <form method="post" action="lab.php?action=add&id=<?php echo $row["product_id"]; ?>">
...
<?php
				if(isset($_POST['com'])){
					...
					echo "<script type='text/javascript'>location.href = 'http://localhost:90/cps/lab.php';</script>";
				}

...
<body>
 ...
 <br>
					...
					<ul class="nav nav-tabs">
					  <li role="presentation" class="active"><a href="#">Active Customers</a></li>
						...
						<th class="col-sm-1">Status</th>
									...
									<tbody>
													...
													if ($conn->connect_error) {
														...
														$conn = "SELECT * FROM customer where status = 'Active' ORDER BY id DESC";  
															...
															<select name="forma" onchange="location = this.value;" class="btn btn-success">
															 <option value="#">Active</option>
															 <option value="update_not_active.php?id=<?php echo $p['id']; ?>" class="btn btn-danger">Not Active</option>
															</select>
															</th>
															</tr>
															<?php

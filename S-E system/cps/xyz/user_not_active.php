...
<body>
 ...
 <br>
					...
					<ul class="nav nav-tabs">
					  ...
					  <li role="presentation"  class="active"><a href="#">Not Active Customers</a></li>
					   <li role="presentation"><a href="info.php">Customers Info</a></li>
					 
					</ul><br>
					
					<table class="table table-hover table-bordered" id="manageuserTable">
					  <thead>
						<tr style="font-size:15px;">
						  <th class="col-lg-1">Customers ID</th>
						  <th class="col-lg-3">Customers Name</th>
						  <th class="col-sm-1">Age</th>
						  <th class="col-sm-1">Gender</th>
						  <th class="col-lg-4">Contact Number</th>
						  <th class="col-sm-1">House Number</th>
						  <th class="col-lg-3">Street</th>
						  <th class="col-lg-3">Barangay</th>
						...
						<th class="col-lg-3">Status&nbsp;&nbsp;&nbsp;&nbsp;</th>
									...
									<tbody>
													...
													if ($conn->connect_error) {
														...
														$conn = "SELECT * FROM customer where status = 'Not Active' ORDER BY id DESC";  
															...
															<th>
															<select name="forma" onchange="location = this.value;" class="btn btn-danger">
															 <option value="#">Not Active</option>
															 <option value="update_active.php?id=<?php echo $p['id']; ?>" class="btn btn-success">Active</option>
															</select>
															</th>
															</tr>
															<?php

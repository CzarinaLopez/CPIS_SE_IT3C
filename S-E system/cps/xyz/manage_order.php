            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li style="border: 2px solid black;">
                        ...
                        <a href="manage_order.php" style="background-color:white;"><i class="glyphicon glyphicon-shopping-cart" style="color:black;"></i><span style="color:black;"> Manage Orders</span></a>
                    </li>
					<li style="border: 2px solid black;">
...
<!-- edit -->
                ...
                <!-- /.row -->
					  ...
					  <li role="presentation" class="active"><a href="#">Pending Orders</a></li>
					  <li role="presentation"><a href="completed.php">Completed</a></li>
                      ...
                      <tbody>
                                                    ...
                                                    if ($conn->connect_error) {
                                                        ...
                                                        $conn = "SELECT * FROM orders WHERE act = 'Pending' ORDER BY id DESC"; 
                                                            ...
                                                            <tr>
                                                              ...
                                                              <th style="vertical-align:middle;"><?php echo $p['cus_name']; ?></th>
															  ...
															  <th style="vertical-align:middle;"><?php echo $p['via']; ?></th>
                                                              <th>
															
															<select name="forma" onchange="location = this.value;" class="btn btn-warning">
															 <option value="#">Pending</option>
															 <option value="update_pen.php?id=<?php echo $p['id']; ?>" class="btn btn-success">Completed</option>
															</select>
															</th>
                                                            </tr>
                                                            <?php

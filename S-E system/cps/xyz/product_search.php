        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
					...
					<li style="border: 2px solid black;">
                        <a href="#"><i class="glyphicon glyphicon-heart"></i> Chena Chena</a>
                    </li>
					<li style="border: 2px solid black;">
                        <a href="#"><i class="glyphicon glyphicon-star"></i> Gomu Gomu</a>
                    </li>
					<li style="border: 2px solid black;">
						...
						<tr>
						  ...
						  <th class="col-lg-3">Action</th>
										...
										<tbody>
												...
												$sql = "SELECT * FROM product where product_name like '%$search%' or product_id like '%$search%' ORDER BY product_id DESC LIMIT $start_from, $limit";
												$rs_result = mysql_query($sql);
												  while($p = mysql_fetch_array($rs_result)){
												?>
												<tr>
												  <td style="vertical-align:middle;"><?php echo $p['product_id']; ?></td>
												  <td><img src="<?php echo $p['product_image']; ?>" class="img-rounded" width="100" height="90"></td>
												  <td style="vertical-align:middle;"><?php echo $p['product_name']; ?></td>
												  <th style="vertical-align:middle;"><?php echo $p['category']; ?></th>
												  <td style="vertical-align:middle;">$<?php echo $p['product_price']; ?></td>
												  <th><?php echo $p['des']; ?></th>
												  <td style="vertical-align:middle;"><?php echo $p['quantity']; ?></td>
...
<button type="submit" name="submit" class="btn btn-success">Update</button>
											...
											<?php  
												$rs_result = mysql_query("SELECT COUNT(product_id) FROM product where product_name like '%$search%' or product_id like '%$search%'")or die(mysql_error());  
												$c = mysql_fetch_row($rs_result);  
												$total_records = $c[0];
												$total_pages = ceil($total_records / $limit);  
												$pagLink = "<nav><ul class='pagination'>";  
												for ($i=1; $i<=$total_pages; $i++) {  
															 $pagLink .= "<li><a href='product_search.php?search=$search&page=".$i."'>".$i."</a></li>";  
												};  
												echo $pagLink . "</ul></nav>";  
											?>
											</div>
											<script type="text/javascript">
												...
												$('.pagination').pagination({
														...
														hrefTextPrefix : 'product_search.php?search=<?php echo $search;?>&page='
													});
													});
											</script>

            ...
            <div class="modal-content">
               ...
               <!--header -->
                 <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" href="tools.php">&times;</button>
...
<div class="container">
  <div class="row">
        ...
        <?php
          $query = "SELECT * FROM product where category='Tools' ORDER BY product_id ASC";
        ...
        ?>
            <div class="col-md-4">
              <form method="post" action="tools.php?action=add&id=<?php echo $row["product_id"]; ?>">
...
<?php
				if(isset($_POST['com'])){
					...
					echo "<script type='text/javascript'>location.href = 'http://localhost:90/cps/tools.php';</script>";
				}

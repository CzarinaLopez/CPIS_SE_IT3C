...
?>
<html>
<title>Diagnostic and Test</title>
<head>
            ...
            <div class="modal-content">
               ...
               <!--header -->
                 <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" href="dat.php">&times;</button>
...
<div class="jumbotron">
            <div class="container">
                  <h1 class="itro-text">Diagnostic and Test
                  </h1>
            </div> 
</div> 
...
<div class="container">
  <div class="row">
        ...
        <?php
          $query = "SELECT * FROM product where category='Diagnostic and Test' ORDER BY product_id ASC";
        ...
        ?>
            <div class="col-md-4">
              <form method="post" action="dat.php?action=add&id=<?php echo $row["product_id"]; ?>">
...
if(isset($_POST["add"]))
{
    if(isset($_SESSION["cart"]))
  {
    ...
    if(!in_array($_GET["id"], $item_array_id))
    {
      ...
      echo '<script>window.location="dat.php"</script>'; 
    }
    else
    {
...
<?php
				if(isset($_POST['com'])){
					...
					echo "<script type='text/javascript'>location.href = 'http://localhost:90/cps/dat.php';</script>";
				}
